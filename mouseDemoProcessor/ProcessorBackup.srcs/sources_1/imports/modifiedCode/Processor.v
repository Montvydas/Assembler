...
parameter [7:0] IF_A_EQUALITY_B_GOTO_FINAL	= 8'h44;

//goto to a spec addr
parameter [7:0] GOTO_ADDR             	= 8'h50; //	also branch equal
parameter [7:0] GOTO_ADDR_0             = 8'h51;
parameter [7:0] GOTO_ADDR_FINAL        = 8'h52;
...
parameter [7:0] FUNCTION_START_FINAL  	= 8'h72;

parameter [7:0] RETURN          		= 8'h80; //return instr using step this
parameter [7:0] RETURN_FINAL   		= 8'h80;
...
parameter  	LOAD_VAL_A 			= 	8'hB0;	//load val instruction is performed using this
parameter 	LOAD_VAL_A_0		= 	8'hB1;
parameter 	LOAD_VAL_B 			= 	8'hB2;
parameter 	LOAD_VAL_B_0		=	8'hB3;
parameter	LOAD_VAL_FINAL		= 	8'hB4;
...
//Check for equality
	...
	IF_A_EQUALITY_B_GOTO_0:
	     begin
	     NextState = IF_A_EQUALITY_B_GOTO_FINAL;
	     	if(AluOut==8'h01)
	        		NextProgCounter = ProgMemoryOut;
	        	else
	            NextProgCounter = CurrProgCounter + 2;
    	...
    	IF_A_EQUALITY_B_GOTO_FINAL:begin
     	NextState = CHOOSE_OPP;
    end                
                  ...
                  //Jump op in here
                        ...
                        GOTO_ADDR_0:begin
                            NextProgCounter=ProgMemoryOut;
                            NextState=GOTO_ADDR_FINAL;
                        end
                        
                        GOTO_ADDR_FINAL:NextState = CHOOSE_OPP;
			...
			begin
                  ...
                  //first step is to wait unitl the address is read from the ROM
                         ...
                         FUNCTION_START_0:begin
                            ...
                            NextState=FUNCTION_START_FINAL;
                         end
                         
                         FUNCTION_START_FINAL:NextState = CHOOSE_OPP;
                  ...
                  //no wait status, but just let the program counter to be the stored vale
                         RETURN:begin
                         	NextProgCounterOffset = 2'h0;
                            NextState=RETURN_FINAL;
                            NextProgCounter=CurrProgContext;
                         end
                         
                         RETURN_FINAL:NextState = CHOOSE_OPP;
